...
function PostsList() {
  ...
  return (
    ...
    <Timeline.Item color="green">{post.updated_at}</Timeline.Item>
            ...
            <svg onClick={() => deletePost(post._id)} className='trash' xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
